...
# of the GRAPH. The DEPTH FIRST SEARCH(BFS) algorithm
# is APPLIED to the GREAPH for FINDING the LIST of
...
class cl_reach_graph:
    ...
    def build_reach_graph(me):
        ...
        for m in range(me.edges_n):
            v_a = chr(ord('a') + mr.randint(0, me.vertices_n - 1))
